    ...
    <div className="mx-auto max-w-6xl space-y-6 px-4 pb-24 pt-6 md:pb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-foreground font-mono tracking-tight">Paito Warna</h1>
        </div>
            ...
            <thead>
              <tr className="bg-muted/20 text-[10px] sm:text-xs uppercase tracking-wider text-muted-foreground border-b border-border/50">
                ...
                {MARKET_SESSIONS[activeMarket].map(t => (
                  <th key={MARKET_SESSION_LABELS[activeMarket][t]} className="p-2 sm:p-3 border-r border-border/50 font-semibold w-16 sm:w-20 last:border-0">
